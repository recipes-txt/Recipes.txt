      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Current step */}
            <div className="bg-stone-800/60 rounded-2xl p-6 md:p-8 mb-6 border border-stone-700/50 min-h-[180px] flex items-center">
              <p className="cook-step-text text-stone-100 leading-relaxed">
